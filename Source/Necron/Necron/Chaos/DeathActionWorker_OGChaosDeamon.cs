...
namespace Verse
{
    ...
    public class DeathActionWorker_OGChaosDeamon : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse)
        {
            ...
            if (corpse.InnerPawn.kindDef == OGChaosDeamonDefOf.ChaosDeamonHorrorBlue)
            {
                if (logging == true) Log.Message(string.Format("DDAWC 0 a"));
                spawn = true;
                pawnKindDef = OGChaosDeamonDefOf.ChaosDeamonHorrorBrimstone;
            }
            else if (corpse.InnerPawn.kindDef == OGChaosDeamonDefOf.ChaosDeamonHorrorPink)
            {
                if (logging == true) Log.Message(string.Format("DDAWC 0 b"));
                spawn = true;
                pawnKindDef = OGChaosDeamonDefOf.ChaosDeamonHorrorBlue;
            }
            else
            {
            ...
            if (position != null && map != null)
            {
                ...
                GenExplosion.DoExplosion(position, map, 1.9f, OGChaosDeamonDefOf.OGCDWarpfireDeath, corpse.InnerPawn, -1, -1f, null, null, null, null, null, 0f, 1, false, null, 0f, 1, 0f, false);
            }
