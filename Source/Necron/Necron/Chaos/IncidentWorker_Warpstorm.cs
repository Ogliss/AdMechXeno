...
namespace RimWorld
{
    ...
    public class IncidentWorker_Warpstorm : IncidentWorker
    {
        ...
        protected override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            return !map.gameConditionManager.ConditionIsActive(OGChaosDeamonDefOf.Warpstorm);
        }
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            GameCondition_Warpstorm gameCondition_Warpstorm = (GameCondition_Warpstorm)GameConditionMaker.MakeCondition(OGChaosDeamonDefOf.Warpstorm, duration, 0);
