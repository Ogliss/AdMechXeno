...
namespace RimWorld
{
    ...
    public class Warpfire : Fire
    {
        ...
        public static void ThrowFireGlow(IntVec3 c, Map map, float size)
        {
            ...
            MoteThrown moteThrown = (MoteThrown)ThingMaker.MakeThing(OGChaosDeamonDefOf.Mote_WarpFireGlow, null);
        ...
        public static void ThrowMicroSparks(Vector3 loc, Map map)
        {
            ...
            MoteThrown moteThrown = (MoteThrown)ThingMaker.MakeThing(OGChaosDeamonDefOf.Mote_MicroSparksWarp, null);
        ...
        private void DoWarpfireDamage(Thing targ)
        {
            ...
            if (pawn != null)
            {
                ...
                DamageInfo dinfo = new DamageInfo(OGChaosDeamonDefOf.OGCDWarpfire, (float)num2, 0f, -1f, this, null, null, DamageInfo.SourceCategory.ThingOrUnknown, null);
                ...
                {
                    apparel.TakeDamage(new DamageInfo(OGChaosDeamonDefOf.OGCDWarpfire, (float)num2, 0f, -1f, this, null, null, DamageInfo.SourceCategory.ThingOrUnknown, null));
                }
            }
            else
            {
                targ.TakeDamage(new DamageInfo(OGChaosDeamonDefOf.OGCDWarpfire, (float)num2, 0f, -1f, this, null, null, DamageInfo.SourceCategory.ThingOrUnknown, null));
            }
        }
        ...
        protected void TrySpread()
        {
            ...
            if (Rand.Chance(WarpfireUtility.ChanceToStartWarpfireIn(intVec, base.Map)))
            {
                if (!flag)
                {
                    ...
                    WarpSpark spark = (WarpSpark)GenSpawn.Spawn(OGChaosDeamonDefOf.WarpSpark, base.Position, base.Map, WipeMode.Vanish);
