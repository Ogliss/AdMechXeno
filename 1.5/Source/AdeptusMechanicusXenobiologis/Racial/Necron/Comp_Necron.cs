...
namespace AdeptusMechanicus
{
    public class CompProperties_Necron : CompProperties
    {
        ...
        public EffecterDef reanimationEffecter;
    ...
    public class Comp_Necron : ThingComp
    {
        ...
        public BodyPartRecord necrodermisRegulator;
        public BodyPartRecord NecrodermisRegulator => necrodermisRegulator ??= Pawn.RaceProps.body.AllParts.Find(x => x.def == AdeptusBodyPartDefOf.OG_Necron_NecrodermisRegulator);
        public BodyPartRecord reanimationMatrix;
        public BodyPartRecord ReanimationMatrix => reanimationMatrix ??= Pawn.RaceProps.body.AllParts.Find(x => x.def == AdeptusBodyPartDefOf.OG_Necron_ReanimationMatrix);
        public BodyPartRecord phasicCapacitor;
        public BodyPartRecord PhasicCapacitor => phasicCapacitor??= Pawn.RaceProps.body.AllParts.Find(x => x.def == AdeptusBodyPartDefOf.OG_Necron_PhasicCapacitor);
        ...
        public void TryPhase()
        {
            ...
            if (Rand.Chance(PhaseChance))
            {
                ...
                {
                    Log.Message("TryPhase 1.1");
                    FleckMaker.Static(Pos, Map, Props.phaseFleck ?? FleckDefOf.PsycastSkipInnerExit, 0.5f);
        ...
        public void TryRevive(bool ForcedRevive = false)
        {
            ...
            if (Rand.Chance(ReanimateChance) || ForcedRevive)
            {
                ...
                ThrowNecronGlow(Pos.ToVector3(), Map, Props.glowRadius);
        ...
        public void TryHeal(bool Forced = false)
        {
            ...
            if (HealableHediffs.Any(x => !Pawn.health.hediffSet.PartIsMissing(x.Part) && x is Hediff_Injury))
            {
            ...
            else if (HealableHediffs.Any(x => x.def == AdeptusHediffDefOf.OG_Regenerating))
            {
            ...
            else if (HealableHediffs.Any(x => Pawn.health.hediffSet.PartIsMissing(x.Part)))
            {
