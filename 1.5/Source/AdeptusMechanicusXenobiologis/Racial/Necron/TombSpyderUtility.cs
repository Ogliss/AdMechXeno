...
namespace AdeptusMechanicus
{
    ...
    public static class TombSpyderUtility
    {
        ...
        public static bool TryFindGoodRepairTarget(Pawn Spyder, float maxDist, out Pawn Target, List<Thing> disallowed = null)
        {
            ...
            {
                Pawn pawn = t as Pawn;
                return pawn.RaceProps.FleshType == AdeptusFleshTypeDefOf.OG_Flesh_Construct_Necron && pawn.TryGetCompFast<Comp_Necron>()!=null && (pawn.Downed) && pawn.Faction == Spyder.Faction && Spyder.CanReserve(pawn, 1, -1, null, false) && (disallowed == null || !disallowed.Contains(pawn));
            };
        ...
        public static bool TryFindGoodRessTarget(Pawn Spyder, float maxDist, out Corpse Target, List<Thing> disallowed = null)
        {
            ...
            Predicate<Thing> validator = delegate (Thing t)
            {
                ...
                return pawn.InnerPawn.RaceProps.FleshType == AdeptusFleshTypeDefOf.OG_Flesh_Construct_Necron && (pawn.TryGetCompFast<Comp_Necron>() != null || pawn.InnerPawn.TryGetCompFast<Comp_Necron>() != null) && pawn.InnerPawn.Faction == Spyder.Faction && Spyder.CanReserve(pawn, 1, -1, null, false) && (disallowed == null || !disallowed.Contains(pawn));
            };
