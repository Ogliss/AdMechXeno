...
namespace AdeptusMechanicus
{
    ...
    public class IncidentWorker_Monolith : IncidentWorker
    {
        ...
        public override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            {
                IntVec3 intVec;
                if (!CellFinderLoose.TryFindSkyfallerCell(ThingDefOf.CrashedShipPartIncoming, map, ThingDefOf.CrashedShipPartIncoming.terrainAffordanceNeeded, out intVec, 14, default(IntVec3), -1, false, true, true, true, true, false, null))
                {
                    break;
                }
