...
namespace AdeptusMechanicus
{
    ...
    public static class TombSpyderUtility
    {
        ...
        public static bool TryFindGoodRepairTarget(Pawn Spyder, float maxDist, out Pawn Target, List<Thing> disallowed = null)
        {
            ...
            {
                Pawn pawn = t as Pawn;
                return pawn.RaceProps.FleshType == OGNecronDefOf.OG_Flesh_Construct_Necron && pawn.TryGetComp<Comp_NecronOG>()!=null && (pawn.Downed) && pawn.Faction == Spyder.Faction && Spyder.CanReserve(pawn, 1, -1, null, false) && (disallowed == null || !disallowed.Contains(pawn));
            };
        ...
        public static bool TryFindGoodRessTarget(Pawn Spyder, float maxDist, out Corpse Target, List<Thing> disallowed = null)
        {
            ...
            Predicate<Thing> validator = delegate (Thing t)
            {
                ...
                return pawn.InnerPawn.RaceProps.FleshType == OGNecronDefOf.OG_Flesh_Construct_Necron && (pawn.TryGetComp<Comp_NecronOG>() != null || pawn.InnerPawn.TryGetComp<Comp_NecronOG>() != null) && pawn.InnerPawn.Faction == Spyder.Faction && Spyder.CanReserve(pawn, 1, -1, null, false) && (disallowed == null || !disallowed.Contains(pawn));
            };
